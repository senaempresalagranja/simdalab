...
WHERE id_Toma_Muestra=$id";
          ...
          while ($fila=mysqli_fetch_row($query)){
             ?>
                ...
                <div class="row">
                  <div class="col-xs-12">
                    <h3 class="page-header"><i class="fa fa-globe"></i> Identificacion De La Muestra: <?php echo $fila[8] ?>
                ...
                <div class="row invoice-info">
                  ...
                  <div class="col-md-7">
                    <h4>Responsable De Recibir La Toma</h4> 
                    <b>Nombre Responsable:</b> <?php echo $fila[26] ?>
                    <br>
                    <b>Observaciones:</b> <?php echo $fila[27] ?>
                  </div>
                </div>
