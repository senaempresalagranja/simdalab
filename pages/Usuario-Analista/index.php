      ...
      <aside class="main-sidebar hidden-print" style="background-color: #000;">
        <section class="sidebar">
          <div class="user-panel">
            <div class="pull-left image"><img class="img-circle" src="../../assets/imagenes/analista.png" alt="User Image"></div>
          ...
          <ul class="sidebar-menu">
           ...
           <!--  <li class="treeview"><a href="#"><i class="fa fa-th-list"></i><span>Consultar</span><i class="fa fa-angle-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="Consultar/Cons-Personas.php"><i class="fa fa-circle-o"></i>Muestras</a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            ...
            <div class="card">
              <h3 class="card-title"> <center><strong>Bienvenido Usuario Analista</strong></center>  </h3>
              <center><H4 > Este es el usuario que le permitira analizar una muestra de suelos</H4>
