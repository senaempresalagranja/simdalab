                ...
                <div class="tab-content" id="myTabContent">
                  ...
                  <div class="tab-pane fade active in" id="Datos_Basicos">
                    <div class="row">
                      ...
                      $query="SELECT * FROM `toma_muestra` ORDER BY `toma_muestra`. `id_Toma_Muestra` ";
...
<td ><?php echo $fila[3] ?></td>
                          ...
                          <td ><?php echo "<div><a class='btn btn-danger' href='eliminar-Recepcion.php?id_Recepcion_Muestra=".$fila['0']."'><i class='fa fa-lg fa-trash'></i></a></div>"?></td>
