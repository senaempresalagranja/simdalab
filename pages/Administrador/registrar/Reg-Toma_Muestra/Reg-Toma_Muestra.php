                      ...
                      <div class="col-md-4"> 
                        <div class="form-group">
                          ...
                          <select class="form-control" id="tipo_Topografia">
                            ...
                            <option value="sinInformacion">Sin Informacion</option>     
                          </select>
                        </div>
                      </div>
...
<td ><?php echo $fila[7] ?></td>
                          ...
                          <td ><?php echo "<div><a class='btn btn-danger' href='Eliminar-TomaMuestra.php?id_Toma_Muestra=".$fila['0']."'><i class='fa fa-lg fa-trash'></i></a></div>"?></td>
