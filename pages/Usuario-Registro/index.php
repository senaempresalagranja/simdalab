      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
           ...
           <div class="card">
              <h3 class="card-title"> <center><strong>Bienvenido Usuario Registro</strong></center>  </h3>
              <center><H4 > Este es el usuario que le permitira registrar la informacion basica de una muestra de suelos</H4>
