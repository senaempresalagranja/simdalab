    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-flask"></i> Ingresar Analisis De La Muestra</h1>
   ...
   ?>
    ...
    <script>
       function calcu_porosidad() {
        ...
        var resul_porosidad = 1-(densi_real/densi_apa)*100;
      ...
      function Arena() {
        ...
        var Resul_3 = ((100-densidad_1)+(factor_Correcion_T1)/(peso_Muestra_1*100))
      ...
      function Arcilla() {
        ...
        var Resul_4 = ((100-densidad_2)+(factor_Correcion_T2)/(peso_Muestra_2*100))
